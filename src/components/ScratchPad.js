...
class ScratchPad extends Component {
    ...
    render() {
        ...
        <div className="scratch">
            ...
            {/*<strong>To Win, measure the False Coin against the appropriate token: Feather (if light) or Ankh (if heavy), after only using the scale to measure 3 times.</strong>*/}
...
<p>Players can drag the coins onto the balancing scale to perform measurements. Since measurements are counted when the items on each side of the scale are even, add or subtract coins from only one side at a time to avoid accidental measurement counts.
...
<div className="video">
<p>
        {true && <iframe title="vid" id="video" width="640" height="360" src="https://www.youtube.com/embed/sk6q6sG-7Ls?rel=0"  allowFullScreen></iframe> }
</p>
</div>
